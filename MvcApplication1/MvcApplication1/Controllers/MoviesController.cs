...
namespace MvcApplication1.Controllers
{
    public class MoviesController : Controller
    {
        ...
        // No need for [HttpPost] because the method isn't changing the state of the application, just filtering data:
        public ActionResult SearchIndex(string movieGenre, string searchString)
        {
            ...
            //(Without the Distinct modifier, duplicate genres would be added):
